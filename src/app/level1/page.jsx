                ...
                {useStopLoss && (
                  <div className="ml-6 space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-gray-200 text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
                      placeholder="3.5"
                    />
                    <p className="text-white/60 text-xs">
                      Стоп на {stopLossPercent}% ниже линии поддержки
                    </p>
                  </div>
                )}
