...
export default function LevelDownPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="flex">
        <div className="w-64 bg-[#9A8B8B] min-h-screen p-6">
          <h2 className="text-white text-xl font-semibold mb-8">Level Down Analysis</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-2 rounded-lg bg-gray-200 text-gray-800 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-red-400"
            />
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg bg-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-400"
            />
              ...
              <>
                <div className="mb-4 flex items-center justify-between">
                  <h3 className="text-xl font-semibold text-gray-800">
                    {ticker} - График с линией сопротивления
                  </h3>
                  <div className="text-sm text-gray-600">
                    {startDate} - {endDate}
                  </div>
                </div>
                <ResistanceChart data={chartData} ticker={ticker} />
              </>
            )}
          </div>
        </div>
